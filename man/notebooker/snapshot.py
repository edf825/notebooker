...
@click.option('--report-name',
              required=True,
              help='The name of the template to retrieve, relative to the template directory.',)
@click.option('--output-directory',
              required=True,
              help='The name of the directory to which to write output files.')
...
@click.option('--mongo-host',
              default='research',
              help='The Mongoose cluster from which we are retrieving notebook results.')
