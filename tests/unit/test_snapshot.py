...
from man.notebooker import snapshot, constants
...
def test_snapshot_latest_successful_notebooks():
    ...
    with mock.patch(compat_builtin) as fopen, \
        ...
        cli_result = runner.invoke(snapshot.snapshot_latest_successful_notebooks,
...
@mock.patch('man.notebooker.snapshot._write_notebook_html')
@mock.patch('man.notebooker.snapshot._write_notebook_outputs')
def test_write_results(_write_notebook_outputs, _write_notebook_html):
    ...
    _write_notebook_html.assert_has_calls([mock.call(mock.sentinel.result1, mock.sentinel.directory),
                                           mock.call(mock.sentinel.result2, mock.sentinel.directory)])
    _write_notebook_outputs.assert_has_calls([mock.call(mock.sentinel.result1, mock.sentinel.directory),
                                              mock.call(mock.sentinel.result2, mock.sentinel.directory)])
